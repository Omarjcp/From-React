...
export const Counter = () => {
    ...
    return (
        <div className="mt-5">
            ...
            <button onClick={() => decrementar()} className="btn btn-outline-primary mt-2">-1</button>
            <button onClick={() => decrementar(2)} className="btn btn-outline-primary mt-2">-2</button>
        </div>
    )
}